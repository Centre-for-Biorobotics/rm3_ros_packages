...
#define UPDATE_INTERVAL_LIN_ACC 100   // IMU updates its linear acceleration data at this interval.
#define UPDATE_INTERVAL_ROT 100       // IMU updates its rotation vectors and gyroscope data at this interval.
#define BNO080_PUBLISH_INTERVAL 100ms // The IMU is being polled for data at this interval and the imu message is being published.
